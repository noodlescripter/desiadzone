...
export default function LandingPage() {
      ...
      useEffect(() => {
            const getProduct = async function () {
                  const res = await axios.get(`${process.env.NEXT_PUBLIC_BACK_END_URL}/ads/allads`);
                  if (res) {
      ...
      return (
            <main className="container items-center content-center mx-auto">
                        ...
                        <div className="container px-4 md:px-6">
                              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                                          ...
                                          <Link
                                                href="/product/category/realestate"
                                                className="group flex flex-col items-center justify-center gap-2 rounded-lg bg-background p-4 hover:bg-accent hover:text-accent-foreground"
                                                prefetch={false}
                                          >
                                          ...
                                          <Link
                                                href="/product/category/allother"
                                                className="group flex flex-col items-center justify-center gap-2 rounded-lg bg-background p-4 hover:bg-accent hover:text-accent-foreground"
                                                prefetch={false}
                                          >
                  ...
                  <section className="w-full py-12 md:py-24 lg:py-32">
                        <div className="container px-4 md:px-6 shadow-xl py-16">
                              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                                    <div className="space-y-2">
